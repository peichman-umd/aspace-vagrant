...
AppConfig[:data_directory] = '/apps/aspace/aspace/data'
...
#
AppConfig[:db_url] = "jdbc:mysql://localhost:3306/archivesspace?user=as&password=as&useUnicode=true&characterEncoding=UTF-8"
